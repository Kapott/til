...
- [Transfer an lvm volume between hosts using compression and netcat](linux//transfer-lvm-volume-between-hosts-using-netcat.md)  
...
- [Proxychains scanning](pentesting//proxychains-scanning.md)  
